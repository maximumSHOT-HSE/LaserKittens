...
public class SettingsScreen implements Screen {
    ...
    private class Menu {
        ...
        private Label accelerometerLabel = new Label("accelerometer",
                new Label.LabelStyle(laserKittens.getFont(), Color.WHITE));
        private CheckBox showTime = new CheckBox(null, skin);
        private Label showTimeLabel = new Label("timer",
                new Label.LabelStyle(laserKittens.getFont(), Color.WHITE));
        private CheckBox enableFog = new CheckBox(null, skin);
        private Label fogLabel = new Label("enable fog",
                new Label.LabelStyle(laserKittens.getFont(), Color.WHITE));
