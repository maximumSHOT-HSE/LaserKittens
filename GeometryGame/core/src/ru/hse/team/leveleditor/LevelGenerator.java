            ...
            public void createLevel(PooledEngine engine, KittensAssetManager assetManager) {
                ...
                for (SimpleEntity entity : savedLevel.entities) {
                    ...
                    switch (entity.getType()) {
                        case STAR:
                            createStar(entity.getPositionX() * PM, entity.getPositionY() * PM, entity.getSizeX() * PM);
                            break;
                        case MIRROR:
                            createMirror(new Vector2(entity.getPositionX() * PM, entity.getPositionY() * PM),
                                    entity.getSizeX() * PM, entity.getSizeY() * PM, entity.getRotation());
                            break;
                        case WALL:
                            createImpenetrableWall(new Vector2(entity.getPositionX() * PM, entity.getPositionY() * PM),
                                    entity.getSizeX() * PM, entity.getSizeY() * PM);
                            break;
                        case PLAYER:
                            focusedPlayer = createPlayer(entity.getPositionX() * PM, entity.getPositionY() * PM, entity.getSizeX() * PM);
                            break;
                    }
                }
